...
while start_date <= end_date:
	...
	while figure_start_date < figure_end_date:
		...
		# ax.bar(datwise_message_alan.index.tolist(),datwise_message_alan.tolist() , color = 'b', width = 0.5)
		# ax.bar([float(x)-.5 for x in datwise_message_her.index.tolist()],datwise_message_her.tolist() , color = 'r', width = 0.5)
		...
		#plot3
		# alan_total = sum(datwise_message_alan.tolist())
		# her_total = sum(datwise_message_her.tolist())
		# labels = 'Alan', 'her'
		# explode = (0.01, 0.01)
		# ax = plt.subplot(2, 3, i)
		...
		alan_monthly_message_list.append(sum(datwise_message_alan.tolist()))
		her_monthly_message_list.append(sum(datwise_message_her.tolist()))
